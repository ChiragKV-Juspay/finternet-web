...
let make = (~handleNavigate) => {
  <div className="flex flex-col justify-between h-full gap-14">
    ...
    <div className="flex justify-center items-center self-center  w-full h-full">
      ...
      // </div>
      <img
        src="/LoanDisbursedSuccesfully.svg" alt="Description of image" className="h-full w-full"
      />
    </div>
    // </div>
    <div className="flex flex-col gap-5">
