...
import * as Strings from "../Utilities/Strings.res.mjs";
...
function Drawer(props) {
  ...
  var moneyUseCases = Strings.MoneyUseCases.all;
  var propertyUseCases = Strings.PropertyUseCases.all;
  var home = Strings.WebHome.all;
  var tokenManager = Strings.TokenManager.all;
