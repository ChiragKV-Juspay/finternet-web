...
@react.component
let make = (~className=?, ~color=colors.finternetGreen) => {
  <div
    className={className->Belt.Option.getWithDefault(
      "flex flew-row justify-center items-center gap-1",
    )}>
    // {icon}
    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_1294_5199)">
        <path
          opacity="0.4"
