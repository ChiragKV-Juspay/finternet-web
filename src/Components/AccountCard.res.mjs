...
function AccountCard(props) {
  ...
  var __id = props.id;
  var id = __id !== undefined ? __id : "siddharth@finternet";
  var iconColor = __iconColor !== undefined ? __iconColor : Colors.colors.finternetGreen;
  return JsxRuntime.jsxs("div", {
              children: [
                JsxRuntime.jsx("img", {
                      className: "absolute right-0 z-0 -m-5",
                      alt: "Background Image",
                      src: "/GrayGradientBackground.svg"
                    }),
                JsxRuntime.jsxs("div", {
                      children: [
                        JsxRuntime.jsxs("div", {
                        ...
                        JsxRuntime.jsx(SecuredByFinterest.make, {
                              className: "flex flew-row  items-center gap-1 mt-10",
                              color: iconColor
                            })
                      ],
